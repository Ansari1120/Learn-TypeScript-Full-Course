...
const failingResponse = ["Not Found", 404]; //sequence dont matter length not limited -> array

// but you will need to declare its type as a tuple.

const passingResponse: [string, number] = ["{}", 200]; //sequence matter length is limited -> tuple 
