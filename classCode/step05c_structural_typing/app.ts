...
// objects fresh or stale 

//stale object placed in another object will be allowed to be run 

//fresh object name type should be same as it is defined in the block body
...
let d : {name:string,income:number} = p;


// let p {name:string} = {
//   name : 'abc',
//   income : 30000     //Object literal may only specify known properties, and 'income' does not exist in type '{ name: any; }'
// }